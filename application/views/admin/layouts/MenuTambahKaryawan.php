                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="<?php echo base_url(); ?>karyawan/tambahKaryawan" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="start_date" class="col-form-label">SKTM (dd/mm/yyyy)</label>
                                                <input id="start_date" name="start_date" type="text" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="salary" class="col-form-label">Honorium</label>
                                            ...
                                            <div class="form-group">
                                                <label for="nik" class="col-form-label">NUPTK/NPK</label>
