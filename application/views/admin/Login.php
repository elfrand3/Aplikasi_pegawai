...
<body class="bg-dark">
    ...
    <div class="splash-container">
        <div class="card">
            <div class="card-header bg-primary text-center"><a class="navbar-brand text-white" href="#"><img src="<?= base_url(); ?>assets/images/logos.png" alt="User Avatar" width="100px"></a><span class="splash-description">ADMINISTRASI DATA GURU</span></div>
            <div class="card-body bg-dark">
                <form method="POST" action="<?= base_url(); ?>auth/loginKaryawan">
                    <div class="form-group">
                        <input class="form-control form-control-lg" name="nik" type="number" placeholder="NUPTK/NPK" autocomplete="off">
                    </div>
                    <div class="form-group">
