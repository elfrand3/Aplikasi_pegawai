                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="tentang-block">
                                                    ...
                                                    Pegawai wajib absen satu hari sekali, jika tidak maka akan di anggap tidak hadir.</p><hr>
                                                    ...
                                                    <a href="<?= base_url(); ?>user/absenKaryawan/<?= $dataKaryawan[0]->id; ?>" class="btn btn-success float-left"><font color="WHITE">Absen</font></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
